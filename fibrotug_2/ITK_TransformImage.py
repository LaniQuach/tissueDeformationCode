...
#load both arrays
def elastix_transformation(originalArray, movingArray):
    fixed_array = originalArray
    moving_array = movingArray
...
######### Deformation Field #########
def displacement_field_elastix(resultParameters, movingImage_array):
    movingImage = itk.GetImageFromArray(movingImage_array)
