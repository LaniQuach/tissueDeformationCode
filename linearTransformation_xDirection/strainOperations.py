...
def secondDeriv(displ_x, displ_y):
    ...
    deriv_x_ydir = (displ_x[2:,1:-1]-displ_x[1:-1,1:-1])/(2*pixelSize)

    #  dux/dy
    deriv_x_xdir = (displ_x[1:-1,2:]-displ_x[1:-1,1:-1])/(2*pixelSize)
    
    # in the y displacement field need both the derivative in the x and y direction
    # duy/dx
    deriv_y_ydir = (displ_y[2:,1:-1]-displ_y[1:-1,1:-1])/(2*pixelSize)
    
    #  duy/dy
    deriv_y_xdir = (displ_y[1:-1,2:]-displ_y[1:-1,1:-1])/(2*pixelSize)
...
def plot_deriv(derivMatrix, outfldr, save):
    ...
    axs[0][0].axis('off')
    axs[0][0].set_title('deformation xx direction', fontsize=30)
    ...
    axs[0][1].axis('off')
    axs[0][1].set_title('deformation xy direction', fontsize=30)  
    ...
    axs[1][0].axis('off')
    axs[1][0].set_title('deformation yx direction', fontsize=30)  
